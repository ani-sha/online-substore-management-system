...
{
    public partial class User_CR : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.CommandText = "Insert into UserIN(ReqNo,PNo,Mcode,Mdesc,ReqDate,AppDate,QtySp,ReqQty,AppStatus,ApprovedQty) Values(@ReqNo,@PNo,@Mcode,@Mdesc,@ReqDate,'-',@QtySp,@ReqQty,'N','-')";
